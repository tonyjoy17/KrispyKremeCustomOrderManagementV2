...
@Component({
    ...
    <div class="layout">
      <aside class="sidebar">
        ...
        <div class="store-badge">
          <div class="store-avatar">F</div>
          <div>
            <div class="store-name">{{ storeName }}</div>
            <div class="store-code">Production Team</div>
          </div>
        </div>
        <nav class="sidebar-nav">
          ...
          <a routerLink="/factory/production-sheet" routerLinkActive="active" class="nav-item">
            <svg viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M5 2a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7.414A2 2 0 0014.414 6l-4-4A2 2 0 009 2H5zm3 8a1 1 0 000 2h4a1 1 0 100-2H8zm-1 4a1 1 0 011-1h4a1 1 0 110 2H8a1 1 0 01-1-1z" clip-rule="evenodd"/></svg>
            Production Sheet
          </a>
        </nav>
  ...
  styles: [`
    ...
    .store-badge { display:flex; align-items:center; gap:10px; padding:14px 20px; background:#fff8ee; margin:12px; border-radius:10px; }
    .store-avatar { width:36px; height:36px; background:#d97706; color:white; border-radius:8px; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:16px; flex-shrink:0; }
...
export class FactoryLayoutComponent {
  ...
  get storeName() { return this.authService.currentUser?.storeName || 'Factory'; }
